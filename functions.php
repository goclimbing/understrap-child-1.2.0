...
function cptui_register_my_cpts()
{
	...
	/**
	 * Post Type: Photographs.
	 */

	$labels = [
		"name" => esc_html__("Photographs", "understrap-child"),
		"singular_name" => esc_html__("Photograph", "understrap-child"),
	];

	$args = [
		"label" => esc_html__("Photographs", "understrap-child"),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		...
		"hierarchical" => false,
		"can_export" => true,
		"rewrite" => ["slug" => "photographs", "with_front" => true],
		"query_var" => true,
...
function cptui_register_my_taxes()
{
	...
	$labels = [
		"name" => esc_html__("Featured", "understrap-child"),
		"singular_name" => esc_html__("Featured", "understrap-child"),
	];


	$args = [
		"label" => esc_html__("Featured", "understrap-child"),
		"labels" => $labels,
		"public" => true,
		"publicly_queryable" => true,
		"hierarchical" => false,
	...
	register_taxonomy("featured", ["photographs"], $args);
}
